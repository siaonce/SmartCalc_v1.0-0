...
// при пустом вводе выведет на экран 0
void MainWindow::on_b_clear_clicked() {
  ui->comments->setText("");
  ui->display->setPlainText("0");
  bad_answer_in_display = 0;
}
// при удалении отработка ошибок
...
// при вводе неверных данных отработка ошибок
...
// при нажатии на кнопку графа открывает окно с отрисованным графиком
